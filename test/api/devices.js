...
describe('Devices', () => {
  ...
  describe('PUT /devices', () => {
    it('204s when provided details and idfv', done => {
      const fields = {
        idfv: '1234',
    ...
    it('204s when provided existing idfv and new fcmRegistrationId', done => {
      const fields = {
        idfv: '1234',
    ...
    it('204s when provided details and existing idfv', done => {
      const fields = {
        idfv: '1234',
        details: androidDetails,
      };
    ...
    it('400s when not provided idfv', done => {
      const fields = {
        details: androidDetails,
      };
